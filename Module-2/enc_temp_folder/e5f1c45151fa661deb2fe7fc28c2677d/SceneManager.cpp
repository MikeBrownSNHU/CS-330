...
void SceneManager::RenderScene()
{
	...
	/******************************************************************/
	/***					11.3.2025 Mike Brown					***/
	/*** No adjustments needed will make all changes to the second  ***/
	/*** pyramid													***/
	/******************************************************************/
	...
	/******************************************************************/
	/***					11.3.2025 Mike Brown					***/
	/*** Rotate 180 degrees around the Z axis to flip the pyramid	***/
	/*** This orientation so the tip points downward				***/
	/******************************************************************/
	// set the XYZ rotation for the mesh
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	...
	/******************************************************************/
	/***					11.3.2025 Mike Brown					***/
	/*** To get the proper offeset I needed Move the top pyramid	***/
	/*** up on the Y axis by 1. This moves the pyrimad up to allow	***/
	/*** the to points to touch										***/
	/******************************************************************/
	// set the XYZ position for the mesh
