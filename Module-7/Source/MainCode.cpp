...
int main(int argc, char* argv[])
{
	...
	// Hook global pointer used by ViewManager (for L key toggle)
	g_pSceneManager = g_SceneManager;
	...
	SceneManager sceneMgr(&shaderMgr);
	g_pSceneManager = &sceneMgr;  // <-- hook global used by ViewManager

	// your ViewManager likely gets created here too
	ViewManager viewMgr(&shaderMgr);
